...
**Link:** [Leetcode](https://leetcode.com/problems/total-score-of-dungeon-runs)
...
## 🧠 Intuition
- Think that how many subarrays thorugh this current element can ?
- Left kadun chalu kelya nantr konta point pasun suru kelya nntr currnt element satisfy krto 
- Mhnje to kiti subarrays madhe add hou shakto tyacha count calculate add karat chalaycha 


---

## 📝 Approach
- Make a prefix Sum array of damages
- Then from starting from 0 index check which is satisfying the conditions
